...
const appDescription = {
  ...
  'Стартовая страница и навигация': [
    '+20',
    'выполнены требования к верстке и оформлению',
    'есть навигация для 2 типов викторины и иконка настроек',
  ],
  Настройки: [
    '+40',
    'есть возможность регулировать звук, а также включать/отключать его кликами по иконкам',
    'есть возможность включать/отключать игру на время и регулировать время между 5 и 30 секундами с шагом в 5 секунд кликами по кнопкам',
    'при перезагрузке результат сохраняется',
  ],
  'Страница категорий': [
    '+30',
    'выполнены требования к верстке и оформлению',
    'на странице категорий размещаются подписанные карточки категорий',
    'над карточками справа отображается прогресс (если есть)',
    'между карточками с прогрессом и без есть различие в цвете',
  ],
  'Страница с вопросами': [
    '+50',
    'выполнены требования к верстке и оформлению',
    'варианты ответов генерируются случайным образом и разные, есть лишь 1 правильный и имеет случайное расположение',
    'после выбора ответа появляется окно с верным ответом',
    'правильному/неправильному ответу присвоены различные индикаторы (как в прогрессе игры так и на карточке-результате)',
    'по кнопке Next продолжается игра до финального вопроса, затем выводится количество правильных ответов',
    'имеется недоработка: если все вопросы были отвечены неверно и затем выбрать опцию сыграть снова - игра начнет вести себя некорректно, т.к. данный функционал еще не был реализован',
  ],
  'Страница с результатами': [
    '+50',
    'выполнены требования к верстке и оформлению',
    'страница с результатами открывается кликом по изображению конкретной категории, по клику по выскакивающей кнопке снизу предлагается сыграть в данную категорию',
    'картины на которые даны верные ответы - цветные, другие - черно-белые',
    'при наведении на картину вывдится информация о ней: название, автор, год создания',
    'при повторной игре категории сохраняется новый результат',
    'имеется недоработка: при ответе на финальный вопрос категории и выборе варианта продолжить игру, прогресс сохраняется, но отображается не сразу, чтобы его увидить необходимо, например, перезайти в категории',
  ],
  'Одновременная загрузка и плавная смена изображений': ['0', 'на данный момент плавная загрузка еще не реализована'],
  Анимация: [
    '+20',
    'анимированы все иконки, особенно иконка настроек (просто залюбоваться можно)',
    'есть анимация всех карточек категорий при наведении',
    'есть анимация всех кнопок',
    'есть анимация появления информации при наведении на картину категории',
  ],
  'Дополнительный функционал на выбор': ['+10', 'немного доработан дизайн', 'хорошее качество выполненной работы'],
};

console.table(appDescription);
