...
<section class="config dresser-wrapper__config">
  ...
  <div class="config-tree config__trees">
    ...
    <ul class="config-tree__list config__list">
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/1.webp" alt="option of xmas-tree image" />
      </li>
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/2.webp" alt="option of xmas-tree image" />
      </li>
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/3.webp" alt="option of xmas-tree image" />
      </li>
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/4.webp" alt="option of xmas-tree image" />
      </li>
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/5.webp" alt="option of xmas-tree image" />
      </li>
      <li class="config-tree__item">
        <img class="config-tree__img" src="./assets/tree/6.webp" alt="option of xmas-tree image" />
      </li>
    </ul>
  </div>
  <div class="config-background config__background">
    ...
    <ul class="config-background__list config__list">
      <li class="config-background__item">
        <img src="./assets/bg/1.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/2.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/3.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/4.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/5.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/6.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/7.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/8.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/9.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
      <li class="config-background__item">
        <img src="./assets/bg/10.webp" alt="xmas-tree background option" class="config-background__img" />
      </li>
    </ul>
  </div>
  <div class="config-light config__light">
    ...
    <ul class="config-light__list config__list">
      <li class="config-light__item config-light__item_color_white"></li>
      <li class="config-light__item config-light__item_color_red"></li>
      <li class="config-light__item config-light__item_color_blue"></li>
      <li class="config-light__item config-light__item_color_green"></li>
      <li class="config-light__item config-light__item_color_yellow"></li>
      <li class="config-light__item config-light__item_color_purple"></li>
      <li class="config-light__item config-light__item_color_pink"></li>
      <li class="config-light__item config-light__item_color_multy"></li>
    </ul>
    <ul class="config-light__custom-list">
      ...
      <li class="color-pick config-light__custom-item">
        ...
        <div class="color-pick__wrapper">
          <input type="color" name="color-pick-multiple" value="#ff0000" class="color-pick__multiple-picker" />
          <input
            type="color"
            name="color-pick-multiple-picker"
            value="#00ff00"
            class="color-pick__multiple-picker"
          />
          <input type="color" name="color-pick-multiple" value="#0000ff" class="color-pick__multiple-picker" />
        </div>
      </li>
    </ul>
    ...
    <ul class="light-options config-light__option-list config__list">
      ...
      <li class="config-light__option-item config-light__option-brightness">
        <h4 class="config-light__option-header">Выбор яркости</h4>
        <div class="light-options__value-wrapper">
          <p class="light-options__brightness-current">
            Текущая яркость: <span data-type="brightness" class="light-options__current-value">100%</span>
          </p>
      ...
      <li class="config-light__option-item config-light__option-speed">
        <h4 class="config-light__option-header">Выбор скорости</h4>
        <div class="light-options__value-wrapper">
          <p class="light-options__speed-current">
            Текущая скорость: <span data-type="speed" class="light-options__current-value">Быстро</span>
          </p>
          <svg class="light-options__show-icon" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            <path d="M33.17 17.17l-9.17 9.17-9.17-9.17-2.83 2.83 12 12 12-12z" />
            <path d="M0 0h48v48h-48z" fill="none" />
      ...
      <li class="config-light__option-item config-light__option-mode">
        <h4 class="config-light__option-header">Выбор режима</h4>
        <div class="light-options__value-wrapper">
          <p class="light-options__mode-current">
            Текущий режим: <span class="light-options__speed-current-value">1</span>
          </p>
          <svg class="light-options__show-icon" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            <path d="M33.17 17.17l-9.17 9.17-9.17-9.17-2.83 2.83 12 12 12-12z" />
            <path d="M0 0h48v48h-48z" fill="none" />
