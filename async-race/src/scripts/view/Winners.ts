import { getPageNavBox, settingTable } from './Util';
...
export class WinnersView {
  ...
  addWinner(data?: object) {
    ...
    tdName.innerText = 'some car name';
    tdWins.innerText = 'some wins';
    tdTime.innerText = 'some time';
